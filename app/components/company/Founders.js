...
// Fallback images used when a founder's `founders_image` is null (e.g. the
// "Amritosh Pandey" entry in the API response), cycled by index.
// const FALLBACK_IMAGES = [bl1, bl2, bl3];

// Prefix Strapi's relative media paths ("/uploads/xxx.png") with your API
// base URL. Swap this for whatever env var your project already uses.
